<?php get_header(); ?>
	...
	<div id="content" class="portfolio-<?php echo $portfolio_width; ?> <?php echo $content_class; ?>" style="<?php echo $content_css; ?>">
		...
		<div class="single-navigation clearfix">
			...
			?>
			<a href="<?php echo $previous_post_link; ?>" rel="prev"><?php _e('Anterior', 'Avada'); ?></a>
			<?php endif; ?>
			<?php
			if($portfolioID || $categoryID) {
			...
			?>
			<a href="<?php echo $next_post_link; ?>" rel="next"><?php _e('Siguiente', 'Avada'); ?></a>
			<?php endif; ?>
		</div>
		<?php endif; ?>
